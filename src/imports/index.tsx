...
import logoAT from "@/assets/logo-architektury.jpg";
import logoPolytech from "@/assets/logo-polytech.png";

export const Route = createFileRoute("/")({
  component: Index,
  head: () => ({
    meta: [
      { title: "АрхитекТуры — студенческое проектное бюро СПбПУ" },
      { name: "description", content: "Студенческое проектное бюро «АрхитекТуры» СПбПУ Петра Великого: экскурсии, проекты, события и культурное наследие Санкт-Петербурга." },
      { property: "og:title", content: "АрхитекТуры — СПбПУ" },
      { property: "og:description", content: "Экскурсии, проекты и история культуры Петербурга." },
    ],
    links: [
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Unbounded:wght@500;700;800&display=swap" },
    ],
  }),
});
...
function Index() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8 flex items-center justify-between h-16">
          <a href="#top" className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="font-display font-bold text-sm tracking-tight">АрхитекТуры</div>
      ...
      <section id="top" className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-5 lg:px-8 pt-16 pb-24 lg:pt-28 lg:pb-36 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 reveal">
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl lg:text-7xl font-extrabold leading-[0.95]">
          ...
          <div className="lg:col-span-5 relative reveal reveal-delay-2">
            <div data-parallax="0.08" className="parallax-y aspect-square rounded-2xl bg-card border border-border shadow-xl overflow-hidden flex items-center justify-center p-10">
              <img src={logoAT} alt="Логотип проектного бюро АрхитекТуры (демо-изображение)" className="w-full h-full object-contain" />
            </div>
            <div className="absolute -bottom-6 -left-6 bg-primary text-primary-foreground px-5 py-4 rounded-xl shadow-lg max-w-[220px]">
              ...
              <div className="font-display font-bold leading-tight mt-1">ИПМЭиТ · Совет по молодёжной политике СПбПУ</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <Section id="about" eyebrow="О бюро" title="Кто мы и зачем">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <aside className="bg-card border border-border rounded-2xl p-6 space-y-5">
            <div>
              <h4 className="font-display font-bold text-lg">Состав актива</h4>
            ...
            <div>
              <h4 className="font-display font-bold text-lg">Управление</h4>
            ...
            <article key={i} className="group bg-card rounded-2xl border border-border overflow-hidden hover:-translate-y-1 transition shadow-sm hover:shadow-xl">
              <div className="aspect-[4/3] overflow-hidden">
                <img src={`https://picsum.photos/seed/portfolio-${i}/800/600`}
                     alt={`Демо-изображение к экскурсии «${p.title}» © picsum.photos`}
          ...
          <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {["Конференция «Студтуризм-2026»", "Форум молодых гидов СЗФО", "Грантовый конкурс ПФКИ", "Фестиваль «Открытый город»", "Ночь музеев СПб", "Питчинг в ИПМЭиТ"].map((t, i) => (
              <div key={i} className="flex gap-4 bg-card border border-border rounded-xl p-4 items-center">
                <img src={`https://picsum.photos/seed/event-${i}/200/200`} alt="Демо-изображение мероприятия" className="w-16 h-16 rounded-lg object-cover" />
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {inDev.map((p, i) => (
            <div key={i} className="relative bg-card border border-border rounded-2xl p-6 overflow-hidden">
              ...
              <h3 className="font-display font-bold text-xl pr-24">{p.title}</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {gallery.map((g, i) => (
            <figure key={i} className="group relative overflow-hidden rounded-xl bg-card border border-border">
              <img
                src={g.src}
                alt={`${g.place}, ${g.date}, фото © ${g.author}, демо-изображение`}
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8 py-12 grid md:grid-cols-3 gap-10">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-display font-bold">АрхитекТуры</div>
      ...
      {/* Yandex.Metrika placeholder — заменить YOUR_COUNTER_ID на реальный счётчик */}
      {/* <script>(function(m,e,t,r,i,k,a){...})(window,document,"script","https://mc.yandex.ru/metrika/tag.js","ym"); ym(YOUR_COUNTER_ID,"init",{clickmap:true,trackLinks:true,accurateTrackBounce:true});</script> */}
    </div>
  );
}
